...
- **Territory only** — only command posts score. No kill points, no HQ.
- **Annihilation only** — only destroyed units score. No command posts, no HQ.
- **No immediate victory** — the HQ is removed. The battle always goes to the end.
- Any combination agreed by the players is valid.
