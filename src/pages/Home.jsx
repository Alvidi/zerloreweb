    ...
    <>
      ...
      <section className="section cta" id="contacto">
        ...
        <div className="cta-grid reveal">
          ...
          >
            <input type="hidden" name="form-name" value="join-contact" />
            <input type="hidden" name="subject" value="ZEROLORE - formulario" />
            ...
            <label className="cta-form-field">
              <span>{t('home.contact.name')}</span>
              <input name="name" type="text" required placeholder={t('home.contact.namePlaceholder')} />
            </label>
            <label className="cta-form-field">
              <span>{t('home.contact.email')}</span>
              <input name="email" type="email" required placeholder={t('home.contact.emailPlaceholder')} />
            </label>
            <label className="cta-form-field">
              <span>{t('home.contact.message')}</span>
              <textarea name="message" rows="3" required placeholder={t('home.contact.messagePlaceholder')} />
            </label>
            <button type="submit" className="ghost">{t('home.contact.submit')}</button>
          </form>
        </div>
      </section>
    </>
